...
export const metadata: Metadata = {
  ...
  description:
    'Vote on 400+ discussion prompts, submit your own, and help shape what gets posted in the Photography Lounge community.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${display.variable} ${body.variable} ${mono.variable} font-body grain`}>{children}</body>
    </html>
  );
}
