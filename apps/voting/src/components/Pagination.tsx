...
export function Pagination({ page, totalPages }: PaginationProps) {
  ...
  return (
    <div className="flex items-center justify-center gap-1">
      ...
      <span className="sm:hidden text-xs text-muted tabular-nums px-1">
        {page} / {totalPages}
      </span>
      <button
        onClick={() => goTo(page + 1)}
