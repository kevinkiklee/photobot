...
export function LoginButton() {
  return (
    <button
      ...
      className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-xl font-medium text-base transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
    >
      {/* Glow backdrop */}
